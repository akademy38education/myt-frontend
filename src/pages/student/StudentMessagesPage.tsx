...
import { useConversationMessages, useConversations, useSendMessage, messagingService } from "@/features/messaging";
...
export function StudentMessagesPage() {
  ...
  if (!conversations || conversations.length === 0) {
    return <EmptyState icon={MessageSquare} title="No conversations yet" description="Once you book a lesson, you'll be able to message your tutor here." />;
  }
